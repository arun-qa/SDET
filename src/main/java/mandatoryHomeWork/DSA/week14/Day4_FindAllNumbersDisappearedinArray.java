...
public class Day4_FindAllNumbersDisappearedinArray {

	/*
	 * https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array 
	 * 1.Declare the list & Set
	 * 2.Add the input in the set 
	 * 3.Iterate with loop with the given length 
	 * 4.check whether the number is exist in set if not then add the number in the list
	 * 
	 * Time complexity-->O[N] 
